...
dijet_variables=[
    ...
    "dijet_Mjj              := GGHMVA.dijet_Mjj",
    "dijet_leadEta          :=  GGHMVA.dijet_leadEta    ",
    "dijet_subleadEta       :=  GGHMVA.dijet_subleadEta ",
    #"dijet_leady            :=  VBFMVA.dijet_leady      ",
    #"dijet_subleady         :=  VBFMVA.dijet_subleady   ",
    "dijet_LeadJPt          :=  GGHMVA.dijet_leadJPt    ",
    "dijet_SubJPt           :=  GGHMVA.dijet_SubleadJPt     ",
    "dijet_leadphi          :=  GGHMVA.leadJet.Phi    ",
    "dijet_subleadphi       :=  GGHMVA.subleadJet.Phi ",
    "dijet_leadE            :=  GGHMVA.leadJet.E    ",
    "dijet_subleadE         :=  GGHMVA.subleadJet.E ",
