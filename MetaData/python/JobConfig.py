...
class JobConfig(object):
    ...
    def __init__(self,*args,**kwargs):
        ...
        try:
            from SimGeneral.MixingModule.mix_2017_25ns_UltraLegacy_PoissonOOTPU_cfi import mix as mix_legacy17
            self.pu_distribs["RunIISummer19UL17"] = mix_legacy17.input.nbPileupEvents
        except Exception:
            print "Failed to load RunIISummer19UL17 mixing"
